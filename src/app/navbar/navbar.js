    ...
    <nav className="tabNavbar ">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="flex md:order-2">
          <a className="textmenu "> admin</a>
          <Link href="/">
            <img className=" ml-7" src="/image/logOut.svg" alt="log out" />
          </Link>
        </div>

        <div
          className=" textmenu items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
          id="navbar-cta"
        >
          <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0   md:border-0 md:bg-gray dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ">
            <li>
              <Link
                href="/main"
                className=" py-2 pl-3 pr-4 text-white bg-white-700 rounded hover:bg-white-100  md:hover:bg-[#E2FEA7] md:hover:text-black md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >
                Main
              </Link>
            </li>
